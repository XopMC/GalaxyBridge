...
GB_TMP=$(mktemp -d "${TMPDIR:-/tmp}/galaxybridge-adb-shell-spec.XXXXXX")
...
xcrun swiftc \
    ...
    "$GB_ROOT/macos/GalaxyBridgeMacTests/ADBClientShellSpec.swift" \
    -o "$GB_TMP/ADBClientShellSpec"

DYLD_LIBRARY_PATH="$GB_TMP" "$GB_TMP/ADBClientShellSpec"
